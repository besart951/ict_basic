...
Git speichert Versionen deines Codes. Du kannst jederzeit zu einer älteren Version zurückkehren.

## Die drei wichtigsten Aktionen

| Aktion | Bedeutung |
|--------|-----------|
| **Commit** | Speichert deine aktuellen Änderungen |
| **Push**   | Lädt deine Commits auf GitHub hoch |
| **Pull**   | Lädt die neuesten Änderungen von GitHub herunter |
...
5. Klicke auf den **Haken ✓** oder den **Commit-Button**, um zu committen

## Visualisierung

```
Datei ändern  →  + (stagen)  →  Commit  →  Push
```
